                    ...
                    exam += `<div class="col-xs-24 col-sm-12 col-md-6 col-lg-6">
                                            <div class="panel panel-primary exam_item">
                                                    ...
                                                    <div class="panel-footer text-center">
                                                        <a href="index.php?module=examination&act=do-exam&id=${exams[i].id}" class="btn btn-sm btn-info">Tham gia
                                                            thi</a>
                                                    </div>
                                                </div>
                                        </div>`;
                    if (i + 1 < exams.length) {
                        exam += `<div class="col-xs-24 col-sm-12 col-md-6 col-lg-6">
                                    <div class="panel panel-primary exam_item">
                                            ...
                                            <div class="panel-footer text-center">
                                                <a href="index.php?module=examination&act=do-exam&id=${exams[i + 1].id}" class="btn btn-sm btn-info">Tham gia
                                                    thi</a>
                                            </div>
                                        </div>
                                </div>`;
                    ...
                    if (i + 2 < exams.length) {
                        exam += `<div class="col-xs-24 col-sm-12 col-md-6 col-lg-6">
                                    <div class="panel panel-primary exam_item">
                                            ...
                                            <div class="panel-footer text-center">
                                                <a href="index.php?module=examination&act=do-exam&id=${exams[i + 2].id}" class="btn btn-sm btn-info">Tham gia
                                                    thi</a>
                                            </div>
                                        </div>
                                </div>`;
                    ...
                    if (i + 3 < exams.length) {
                        exam += `<div class="col-xs-24 col-sm-12 col-md-6 col-lg-6">
                                    <div class="panel panel-primary exam_item">
                                            ...
                                            <div class="panel-footer text-center">
                                                <a href="index.php?module=examination&act=do-exam&id=${exams[i + 3].id}" class="btn btn-sm btn-info">Tham gia
                                                    thi</a>
                                            </div>
                                        </div>
                                </div>`;
