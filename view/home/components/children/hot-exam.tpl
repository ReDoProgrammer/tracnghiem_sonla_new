        ...
        <div class="col-xs-24 col-sm-24 col-md-24 col-lg-24">
            <div class="box row">
                <div class="col-xs-24 col-sm-24 col-md-4 col-lg-4">
                    <a href="#" id="btnHERegulation" data-regulation="" class="t-submit"
                ...
                <div class="col-xs-24 col-sm-24 col-md-4 col-lg-4">
                    <div class="t-start text-center" style="margin-bottom: 5px;">
                        <div class="top">Bắt đầu</div>
                        <div class="bottom" id="he_begin">
                ...
                <div class="col-xs-24 col-sm-24 col-md-4 col-lg-4">
                    <div class="t-end text-center" style="margin-bottom: 5px;">
                        <div class="top">Kết thúc</div>
                        <div class="bottom" id="he_end">
                            <div class="time">00H00</div>
                    ...
                    <div class="t-countdown">
                        ...
                        <div class="bottom" id="he_countdown">
                            <div class="count timeTo timeTo-black" data-time="2023-07-03 23:59:59"
                                ...
                                <div class="first" style="width:24px; height:27px;">
                                    <ul style="left:5px; top:-27px">
                                        <li>2</li>
                                        <li>2</li>
                                    </ul>
                                </div>
                                <div style="width:24px; height:27px;margin-right:10px">
                                    <ul style="left:5px; top:-27px">
                                        <li>6</li>
                                        <li>6</li>
                                    </ul>
                                ...
                                <div class="first" style="width:24px; height:27px;">
                                    <ul style="left: 5px; top: -27px;" class="">
                                        <li>1</li>
                                        <li>1</li>
                                    </ul>
                                </div>
                                ...
                                <div style="width:24px; height:27px;">
                                    <ul style="left: 5px; top: 0px;" class="transition">
                                        <li>5</li>
                                        <li>6</li>
                                    </ul>
                                </div>
...
<link rel="stylesheet" href="assets/css/countdown/countdown.css">
<link rel="stylesheet" href="assets/css/countdown/timeTo.css">
<script src="assets/js/countdown/jquery.time-to.js"></script>
<script src="assets/js/examination/js-hot-exam.js"></script>
