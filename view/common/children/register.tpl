        ...
        <div class="form-detail">
            ...
            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                <div id="avatar">
                    <div class="content">
                        ...
                        <button class="btn btn-xs btn-warning" id="btnImportAvatar"><i class="fa fa-camera"
            ...
            <div class="col-xs-12 col-sm-12 col-md-16 col-lg-16">
                ...
                <div class="form-group">
                    <input type="password" autocomplete="off" class="password required form-control"
                        placeholder="Mật khẩu" value="" id="txtPassword" maxlength="32" data-pattern="/^(.){8,32}$/"
            ...
            <div class="form-group col-xs-24 col-sm-12 col-md-12 col-lg-12 gender">
                <div class="form-group radio-box required input btn-group col-sm-24 gender" >
                  <label class="radio-box" style="margin-right: 5px;"> <input type="radio" name="gender" id="rbtN"
                          value="N" class="input" onclick="validErrorHidden(this,5);">
                      N/A </label>
                  <label class="radio-box" style="margin-right: 5px;"> <input type="radio" name="gender" id="rbtM"
                          value="M" class="input" onclick="validErrorHidden(this,5);" checked="checked">
                      Nam </label>
                  <label class="radio-box" style="margin-right: 0px;"> <input type="radio" name="gender" value="F"
                          id="rbtF" class="input" onclick="validErrorHidden(this,5);">
                      Nữ </label>
                </div>
            </div>
            <div class="form-group  col-xs-24 col-sm-12 col-md-12 col-lg-12 birthdate">
              <div class="input-group">
                <input type="text" class="form-control datepicker required " 
                    data-provide="datepicker" id="txtBirthdate"
                    style="z-index: 1 !important;"
                  placeholder="Ngày tháng năm sinh" value="31/01/2000" id="txtBirthdate" readonly="readonly"
                  onchange="validErrorHidden(this);" onfocus="datepickerShow(this);" data-mess="" />
            ...
            <div class="form-group col-xs-24 col-sm-12 col-md-12 col-lg-12 address">
                <select class="form-control selectpicker" id="slProvinces" data-live-search="true"></select>
            </div>

            <div class="form-group col-xs-24 col-sm-12 col-md-12 col-lg-12 address">
                <select id="slDistricts" class="form-control selectpicker"  data-live-search="true"></select>
            </div>


            <div class="form-group col-xs-24 col-sm-12 col-md-12 col-lg-12 address">
                <select class="form-control selectpicker"  data-live-search="true" id="slWards"></select>
            </div>
            <div class="form-group col-xs-24 col-sm-12 col-md-12 col-lg-12 address">
                <input type="text" class="form-control required input" placeholder="Địa chỉ" value="" id="txtAddress"
                    name="custom_fields[address]" onkeypress="validErrorHidden(this);" data-mess="" />
            </div>



            <div class="form-group col-xs-24 col-sm-24 col-md-24 col-lg-24 workplace">
                <select id="slWorkPlaces" class="form-control selectpicker"  data-live-search="true"></select>
            </div>

            
            <div class="form-group col-xs-24 col-sm-12 col-md-12 col-lg-12 job">
                <select id="slJobs" class="form-control selectpicker"  data-live-search="true"></select>
            </div>
            <div class="form-group col-xs-24 col-sm-12 col-md-12 col-lg-12 position">
                <select id="slPositions"  class="form-control selectpicker"  data-live-search="true"></select>
            </div>
            ...
            <div class="form-group col-xs-24 col-sm-24 col-md-24 col-lg-24 text-center check-box required" data-mess="">
                <input type="checkbox" id="ckbAgreement" />Tôi đồng ý với
                <a onclick="ShowRegisterRules()"><span class="btn btn-default btn-xs">Quy định đăng ký thành viên</span></a>
            </div>
