...
<td style="width: 10%"> <?php echo $member['tai_khoan']; ?> </td>
<td style="width: 15%"> <?php echo $member['ho_ten']; ?> </td>
<td class="text-center" style="width: 15%;"> <?php echo $member['email']; ?> </td>
<td class="text-center">
<span class="label label-danger"> <?php if($member['phan_quyen']=='0') {echo "Thành viên" ;}
            else if($member['phan_quyen']=='1'){echo "Quản trị website" ;}
            else if($member['phan_quyen']=='2'){echo "Phát triển website" ;}
             ?></span>
</td>
<td class="text-center"><?php echo date_format(date_create($member['time_login']),'H:i:s | d-m-Y'); ?> </td>


 <td class="text-center" style="white-space:nowrap">
           <?php echo date_format(date_create($member['ngay_tham_gia']),'d/m/Y'); ?>
                </td>
				
				 <td class="text-center" style="white-space:nowrap">
                         [ <a href="index.php?module=member&act=<?php echo "edit";?>&id=<?php echo $member['id_regedit']; ?>"><i class="fa fa-pencil-square-o"></i></a> ]
						 [ <a href="javascript:confirmDelete('index.php?module=member&act=del&id=<?=$member['id_regedit']?>')"><i class="fa fa-trash-o" style="color: red;"></i></a> ]
						 [	<a href="index.php?module=member&act=<?php echo "add_module_permision";?>&uid=<?php echo $member['cbid']; ?>"><i class="fa fa-file" aria-hidden="true"></i> </a> ]
                </td>
